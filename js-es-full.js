...
const otraFuncion = function(otroString){
...
const funcionUnida = otraFuncion.bind(miObjeto);
...
const porDos = producto.bind(this, 2);
porDos(8); // = 16
...
miObjeto.miFunción(); // = "hello world!"
...
const miNuevoObjeto2 = new MiConstructor();
...
const miNumero = 12;
const miNumeroObjeto = new Number(12);
